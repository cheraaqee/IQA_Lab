...
%     end
% end
the_methods_2 = {'GM_LoG', 'FISBLIM', 'SISBLIM', 'Monogenic', 'GWH_GLBP', 'proposed', 'BOSS', 'JetLBP'};
the_methods_3 = {'GM_LoG', 'GWH_GLBP', 'proposed', 'BOSS', 'JetLBP'};
the_methods_1 = {'GM_LoG', 'GWH_GLBP', 'proposed', 'JetLBP'};
portion = 0.4:0.1:0.7
tabler_v2_f(the_methods_2, datasets, 'experiment_1');
tabler_v3_f(the_methods_3, datasets); % This is for generality tabl
tabler_v4_f(the_methods_1, datasets, portion*100) % for different portions
box_plotter(the_methods_1, datasets)
