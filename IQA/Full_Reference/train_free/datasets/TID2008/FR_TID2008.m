...
for reference = 1:25
    for distortion = 1:17
        for level = 1:4
            ...
            nigeb = toc(begin);
            objective_TID2008(counter,1) = objective;
            objective_TID2008(counter,2) = mos_table{counter,1};
            objective_TID2008(counter,3) = reference;
            objective_TID2008(counter,4) = distortion;
            objective_TID2008(counter,5) = nigeb;
        end
    end
end

save(['objective_TID2008_',evaluator, '.mat'], 'objective_TID2008')
...
save(['objective_TID2008_AGN_',evaluator, '.mat'], 'objective_TID2008_AGN')
save(['objective_TID2008_daNicc_',evaluator, '.mat'], 'objective_TID2008_daNicc')
save(['objective_TID2008_scN_',evaluator, '.mat'], 'objective_TID2008_scN')
save(['objective_TID2008_mN_',evaluator, '.mat'], 'objective_TID2008_mN')
save(['objective_TID2008_hfN_',evaluator, '.mat'], 'objective_TID2008_hfN')
save(['objective_TID2008_iN_',evaluator, '.mat'], 'objective_TID2008_iN')
save(['objective_TID2008_qN_',evaluator, '.mat'], 'objective_TID2008_qN')
save(['objective_TID2008_gB_',evaluator, '.mat'], 'objective_TID2008_gB')
save(['objective_TID2008_ID_',evaluator, '.mat'], 'objective_TID2008_ID')
save(['objective_TID2008_Jpeg_',evaluator, '.mat'], 'objective_TID2008_Jpeg')
save(['objective_TID2008_Jp2k_',evaluator, '.mat'], 'objective_TID2008_Jp2k')
save(['objective_TID2008_jpegT_',evaluator, '.mat'], 'objective_TID2008_jpegT')
save(['objective_TID2008_nepN_',evaluator, '.mat'], 'objective_TID2008_nepN')
save(['objective_TID2008_lBddi_',evaluator, '.mat'], 'objective_TID2008_lBddi')
save(['objective_TID2008_ms_',evaluator, '.mat'], 'objective_TID2008_ms')
save(['objective_TID2008_cc_',evaluator, '.mat'], 'objective_TID2008_cc')
save(['objective_TID2008_jp2kT_',evaluator, '.mat'], 'objective_TID2008_jp2kT')
...
xlswrite(['corr_TID2008_',evaluator,'.xls'], correlations);
disp(correlations);