%% What is the name of your evaluator? Enter it here:
evaluator = 'GMSD';
%%
...
for reference = 1:25
    for distortion = 1:24
        for level = 1:5
            counter = counter +1
            dst_path = ['./distorted_images/i',num2str(reference, '%02d'),'_',num2str(distortion,'%02d'),'_',num2str(level),'.bmp'];
            ref_path = ['./reference_images/i',num2str(reference, '%02d'),'.bmp'];
            dst = imread(dst_path);
            ref = imread(ref_path);
            ...
            nigeb = toc(begin);
            objective_TID2013(counter,1) = objective;
            objective_TID2013(counter,2) = mos_table{counter,1};
            objective_TID2013(counter,3) = reference;
            objective_TID2013(counter,4) = distortion;
            objective_TID2013(counter,5) = nigeb;
        end
    end
end

save(['objective_TID2013_',evaluator, '.mat'], 'objective_TID2013')
...
save(['objective_TID2013_AGN_',evaluator, '.mat'], 'objective_TID2013_AGN')
save(['objective_TID2013_daNicc_',evaluator, '.mat'], 'objective_TID2013_daNicc')
save(['objective_TID2013_scN_',evaluator, '.mat'], 'objective_TID2013_scN')
save(['objective_TID2013_mN_',evaluator, '.mat'], 'objective_TID2013_mN')
save(['objective_TID2013_hfN_',evaluator, '.mat'], 'objective_TID2013_hfN')
save(['objective_TID2013_iN_',evaluator, '.mat'], 'objective_TID2013_iN')
save(['objective_TID2013_qN_',evaluator, '.mat'], 'objective_TID2013_qN')
save(['objective_TID2013_gB_',evaluator, '.mat'], 'objective_TID2013_gB')
save(['objective_TID2013_ID_',evaluator, '.mat'], 'objective_TID2013_ID')
save(['objective_TID2013_Jpeg_',evaluator, '.mat'], 'objective_TID2013_Jpeg')
save(['objective_TID2013_Jp2k_',evaluator, '.mat'], 'objective_TID2013_Jp2k')
save(['objective_TID2013_jpegT_',evaluator, '.mat'], 'objective_TID2013_jpegT')
save(['objective_TID2013_nepN_',evaluator, '.mat'], 'objective_TID2013_nepN')
save(['objective_TID2013_lBddi_',evaluator, '.mat'], 'objective_TID2013_lBddi')
save(['objective_TID2013_ms_',evaluator, '.mat'], 'objective_TID2013_ms')
save(['objective_TID2013_cc_',evaluator, '.mat'], 'objective_TID2013_cc')
save(['objective_TID2013_jp2kT_',evaluator, '.mat'], 'objective_TID2013_jp2kT')
save(['objective_TID2013_ccs_',evaluator, '.mat'], 'objective_TID2013_ccs')
save(['objective_TID2013_mGN_',evaluator, '.mat'], 'objective_TID2013_mGN')
save(['objective_TID2013_comN_',evaluator, '.mat'], 'objective_TID2013_comN')
save(['objective_TID2013_lcNi_',evaluator, '.mat'], 'objective_TID2013_lcNi')
save(['objective_TID2013_CqD_',evaluator, '.mat'], 'objective_TID2013_CqD')
save(['objective_TID2013_ChAb_',evaluator, '.mat'], 'objective_TID2013_ChAb')
save(['objective_TID2013_sSR_',evaluator, '.mat'], 'objective_TID2013_sSR')
...
xlswrite(['corr_TID2013_',evaluator,'.xls'], correlations);
disp(correlations);